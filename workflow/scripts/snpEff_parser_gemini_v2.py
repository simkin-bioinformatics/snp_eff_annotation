'''
like version 1 except I used some prompt engineering to get gemini to create
output tables with exonicFunc calls and "targeted" status. I also split out
large chunks of main into functions to make more modular code, and re-wrote some
of the more convoluted parts to be easier to follow. 
'''
import csv
import gzip
import sys
